...
from .unet_blocks2D import *
from .unet2D import Unet
from .utils2D import init_weights,init_weights_orthogonal_normal, l2_regularisation
...
class Encoder(nn.Module):
    ...
    def __init__(self, input_channels, num_filters, no_convs_per_block, initializers, padding=True, posterior=False):
        ...
        if posterior:
            ...
            self.input_channels += 2 # changed by coco input_channels + segm_channels
